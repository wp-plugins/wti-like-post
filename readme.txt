...
4. 3 different voting styles with 3 set of images.
5. Allow or block guest users to vote.
6. Custom messages.
7. Option to show thumbs up/down functionality on pages or not.
8. Option to exclude specific posts/pages if you do not want this functionality to be shown there.
9. Option to show excluded posts/pages on widget section or not.
